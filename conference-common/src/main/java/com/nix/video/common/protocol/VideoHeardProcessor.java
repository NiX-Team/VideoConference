 ...
 */
public class VideoHeardProcessor implements RemotingProcessor<AbstractMessage> {
    @Override
    public void process(RemotingContext ctx, AbstractMessage msg, ExecutorService defaultExecutor) throws Exception {
        ...
        if (msg.getCmdCode() == MessageCommandCode.HEART_SYN_COMMAND) {
            ...
            ctx.getChannelContext().writeAndFlush(AbstractMessage.createHeardAckMessage());
        }
        //响应心跳
