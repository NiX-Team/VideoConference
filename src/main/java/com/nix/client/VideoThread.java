...
public class VideoThread{
    ...
    private static final VideoThread VIDEO_THREAD = new VideoThread();
    ...
    public synchronized static void start(Exe e) {
        exe = e;
        deviceName = DEFAULT_DEVICE_NAME;
        videoSize = DEFAULT_VIDEO_SIZE;
        frame = DEFAULT_FRAME;
        if (!VIDEO_THREAD.THREAD.isAlive()) {
            VIDEO_THREAD.THREAD.start();
        }
    }
    public static void stop() {
        if (!VIDEO_THREAD.THREAD.isInterrupted()) {
