...
public class DefaultInvokeFuture implements InvokeFuture {
    ...
    private volatile VideoResponseMessage response;
    ...
    public void putResponse(RemotingCommand remotingCommand) {
        this.response = (VideoResponseMessage) remotingCommand;
        ...
        try {
            ...
            if (null != protocol) {
                ...
                if (null != commandHandler) {
                    ...
                    LogKit.error("Executor null in commandHandler of protocolCode [{}].",
                            this.protocol);
                }
            } else {
                LogKit.error("protocolCode [{}] not registered!", this.protocol);
            }
        } catch (Exception e) {
            LogKit.error("Exception caught when executing invoke callback abnormally.", e);
        }
    }
